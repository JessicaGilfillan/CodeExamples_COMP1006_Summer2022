        ...
        if (!empty($_POST['g-recaptcha-response'])) {
          ...
          if (!empty($errors)) {
            ...
            try {
              ...
              $sql = "INSERT INTO tuneshare_users (first_name, last_name, location, email, age, username, password, profile_image) VALUES (:firstname, :lastname, :location, :email, :age, :username, :password, :profile_image)"; 
